...
Future<void> initDependencies() async {
  ...
  getIt.registerLazySingleton<FaceRepository>(() => FaceRepository(apiClient: getIt()));

  // Services
  getIt.registerLazySingleton<FaceVerificationService>(() => FaceVerificationService(getIt()));

  // BLoCs
  getIt.registerFactory<AuthBloc>(() => AuthBloc(authRepository: getIt()));
  getIt.registerSingleton<WalletBloc>(WalletBloc(walletRepository: getIt()));
  ...
  getIt.registerFactory<FaceEnrollBloc>(() => FaceEnrollBloc(getIt(), getIt()));
}