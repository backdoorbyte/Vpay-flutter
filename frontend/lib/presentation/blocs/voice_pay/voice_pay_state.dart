...
class VoicePayConfirm extends VoicePayState {
  ...
  @override
  List<Object?> get props => [parsed, intent, displayText, confirmPrompt, language];
}

class VoicePayNeedsAmount extends VoicePayState {
  final String upiId;
  final String? note;

  VoicePayNeedsAmount({required this.upiId, this.note});

  @override
  List<Object?> get props => [upiId, note];
}
